# Release notes — AIDO by SR3H 0.10.5
...
- a separate render-only tool, preserving the usefulness of all data tools without UI;
...
- stricter skill instructions preventing unsupported card content or repeated rendering;
